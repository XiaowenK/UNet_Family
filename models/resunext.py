...
model_path = {
    'resnext101_32x8d_wsl': r"./models/ig_resnext101_32x8-c38310e5.pth",
}
...
# class ResUNext101(nn.Module):

#     def __init__(self, num_class, pretrained=False):
#         super().__init__()
#         self.factor = 4
#         self.resnet = resnext101_32x8d_wsl(pretrained=pretrained)
#         self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)
#         # Encoder part.
...
#         # Decoder part.
#         self.decoder5 = DecoderBlock(in_channels=512*self.factor, out_channels=256*self.factor)
#         self.decoder4 = DecoderBlock(in_channels=256*self.factor, out_channels=128*self.factor)
#         self.decoder3 = DecoderBlock(in_channels=128*self.factor, out_channels=64*self.factor)
#         self.decoder2 = DecoderBlock(in_channels=64*self.factor, out_channels=64)
#         # Final part.
...
class ResUNext101(nn.Module):
    ...
    def __init__(self, num_class, pretrained=False):
        ...
        self.decoder3 = DecoderBlock(in_channels=128*self.factor, out_channels=64*self.factor)
        # Final part.
        self.final = FinalBlock(in_channels=64*self.factor, mid_channels=32*self.factor, out_channels=num_class)
